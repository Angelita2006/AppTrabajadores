...
class MotivosPausa(Base):
    ...
    empresa: Mapped[Optional['Empresas']] = relationship('Empresas', back_populates='motivos_pausa') # type: ignore
    fichajes: Mapped[list['Fichajes']] = relationship('Fichajes', back_populates='motivo_pausa') # type: ignore
