...
class Fichajes(Base):
    ...
    estado: Mapped[EstadoFichajeEnum] = mapped_column(Enum(EstadoFichajeEnum, values_callable=lambda cls: [member.value for member in cls], name='estado_fichaje_enum'), nullable=False, server_default=text("'valido'::estado_fichaje_enum"))
