...
// para acceder a los valores del contexto desde cualquier componente hijo. El contexto incluye el trabajador actual, una función
// para actualizarlo, la empresa seleccionada y una función para actualizarla.
